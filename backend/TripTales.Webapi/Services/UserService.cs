...
namespace Triptales.Webapi.Services
{
    public class UserService
    {
        ...
        public async Task<User?> GetUserByUsername(string username) => await _db.Users.Include(u => u.Following).Include(u => u.LikedPosts).FirstOrDefaultAsync(u => u.Username == username);
    }
}
